package com.ame.minitwitter.common;
...
public class SharedPreferencesManager {
    ...
    //constructor primer lugar...
    private SharedPreferencesManager(){

    }

    private static SharedPreferences getSharedPreferences(){
        //devolvemos el contexto       nombre donde se almacenara las variables
        return MyApp.getContext()
                .getSharedPreferences(APP_SETTINGS_FILE, Context.MODE_PRIVATE);
    }
    // GUARDA LOS VALORES                        clave     valor de la clave
